...
The first four manual test batches are defined in `data/promotion/outreach-wave-01.csv` through
`data/promotion/outreach-wave-04.csv`, with finished company-level drafts in the matching files under
`docs/promotion/`. Wave 01 covers Australia and New Zealand; wave 02 covers South Africa, the United
Kingdom and Canada; wave 03 covers the United Arab Emirates; wave 04 covers Saudi Arabia. Every row
remains `ready_for_manual_review` until a person rechecks the official source,
...
allowed statuses and campaign-link references. It also validates all four five-company outreach waves,
...
Use the local `arcfort-outreach-tracker.xlsx` workbook as the private operating record for the four
manual outreach waves. It consolidates all twenty company-level candidates and provides:
