...
export function StickyContactBar() {
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-50 w-full max-w-[100vw] overflow-hidden border-t border-white/20 bg-arc-midnight/95 px-2 pb-[calc(0.45rem+env(safe-area-inset-bottom))] pt-2 text-white shadow-industrial backdrop-blur md:inset-x-auto md:bottom-6 md:right-6 md:w-44 md:max-w-none md:border md:px-0 md:py-0"
