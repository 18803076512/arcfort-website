...
const waveDefinitions = [
  ...
  {
    sourcePath: path.resolve("data/promotion/outreach-wave-04.csv"),
    draftPath: path.resolve("docs/promotion/outreach-wave-04.md"),
    expectedWaveId: "saudi_wave_04",
    label: "Outreach wave 04",
  },
] as const;
